...
filename = PhotoImage(file = "add your path")
...
#Developed for Assitive Technology
message = tk.Label(window, text="ATL Face-Recognition Attendance" ,bg="White"  ,fg="black"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline'))
...
def TrackImages():
    ...
    recognizer.read("path to yml file")
    harcascadePath = "haarcascade_frontalface_default.xml"
    ...
    fileName="path to attendance folder"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"
